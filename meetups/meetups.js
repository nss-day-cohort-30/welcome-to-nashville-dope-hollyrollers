...
const eventFactory = (currentEvent) => {
    return `
    <div class="eventElement" id="${currentEvent.name}">
    <h4>Event: ${currentEvent.name.text}</h4> <button id="button--${currentEvent.name}" class="saveMeetBtn">Save to Itinerary</button>
